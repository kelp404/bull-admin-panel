    ...
    return (
      <ul className="nav nav-tabs mb-2">
        <li className="nav-item">
          ...
          >
            Active
            {jobCounts && <span className="badge badge-pill badge-secondary ml-1">{utils.formatNumber(jobCounts.active)}</span>}
          </Link>
        </li>
        <li className="nav-item">
          <Link
          ...
          >
            Waiting
            {jobCounts && <span className="badge badge-pill badge-secondary ml-1">{utils.formatNumber(jobCounts.waiting)}</span>}
          </Link>
        </li>
        <li className="nav-item">
          <Link
          ...
          >
            Completed
            {jobCounts && <span className="badge badge-pill badge-secondary ml-1">{utils.formatNumber(jobCounts.completed)}</span>}
          </Link>
        </li>
        <li className="nav-item">
          <Link
          ...
          >
            Failed
            {jobCounts && <span className="badge badge-pill badge-secondary ml-1">{utils.formatNumber(jobCounts.failed)}</span>}
          </Link>
        </li>
        <li className="nav-item">
          <Link
            className={classNames('nav-link', {active: currentState === jobStates.DELAYED})}
            to={{name: 'web.jobs', params: {queue: currentQueue, state: jobStates.DELAYED}}}
          >
            Delayed
            {jobCounts && <span className="badge badge-pill badge-secondary ml-1">{utils.formatNumber(jobCounts.delayed)}</span>}
          </Link>
        </li>
        <li className="nav-item">
          <Link
            className={classNames('nav-link', {active: currentState === jobStates.PAUSED})}
            to={{name: 'web.jobs', params: {queue: currentQueue, state: jobStates.PAUSED}}}
          >
            Paused
            {jobCounts && <span className="badge badge-pill badge-secondary ml-1">{utils.formatNumber(jobCounts.paused)}</span>}
          </Link>
        </li>
      </ul>
    );
