  ...
  render() {
    const classTable = {
      ...
      allTypesLink: classNames([
        ...
        {'list-group-item-secondary active': !this.props.params.type}
      ])
    };
    this.props.types.forEach(type => {
      classTable[`${type}TypeLink`] = classNames([
        'list-group-item list-group-item-action text-truncate',
        {'list-group-item-secondary active': this.props.params.type === type}
      ]);
    });
    const quantity = {
              ...
              <div className="col-3">
                <div className="list-group">
                  <Link key="type-all"
                    ...
                    title="All types"
                    to={{name: 'web', params: {state: this.state.currentState, sort: this.props.params.sort}}}
                  >
                    All types
                  </Link>
                  {
