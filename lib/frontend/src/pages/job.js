  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Modal.Footer>
          <button className="btn btn-outline-danger" type="button" onClick={this.onClickRemoveButton}>
            Remove
          </button>
          {
            job.state === jobStates.FAILED && (
              <button className="btn btn-outline-primary" type="button" onClick={this.onClickRetryButton}>
                Retry
              </button>
            )
          }
