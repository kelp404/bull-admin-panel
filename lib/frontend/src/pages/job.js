  ...
  render() {
    ...
    const classTable = {
      stateBadge: classNames(['badge', {
        'badge-secondary': [jobState.INACTIVE, jobState.DELAYED].indexOf(job.state) >= 0,
        'badge-primary': job.state === jobState.ACTIVE,
        'badge-success': job.state === jobState.COMPLETE,
        'badge-danger': job.state === jobState.FAILED
      }])
    };
