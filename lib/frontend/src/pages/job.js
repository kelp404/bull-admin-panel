  ...
  render() {
    const classTable = {
      stateBadge: classNames(['badge', {
        'badge-secondary': [jobState.INACTIVE, jobState.DELAYED].indexOf(this.props.job.state) >= 0,
        'badge-primary': this.props.job.state === jobState.ACTIVE,
        'badge-success': this.props.job.state === jobState.COMPLETE,
        'badge-danger': this.props.job.state === jobState.FAILED
      }])
    };
